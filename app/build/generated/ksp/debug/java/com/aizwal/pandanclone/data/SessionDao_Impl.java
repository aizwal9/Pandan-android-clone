...
public final class SessionDao_Impl implements SessionDao {
  ...
  public SessionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSessionEntity = new EntityInsertionAdapter<SessionEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `sessions` (`id`,`startTime`,`endTime`,`durationMs`) VALUES (nullif(?, 0),?,?,?)";
      }
  ...
  @Override
  public Flow<List<SessionEntity>> getSessionsForDay(final long startOfDay) {
    final String _sql = "SELECT * FROM sessions WHERE startTime >= ? ORDER BY startTime DESC";
